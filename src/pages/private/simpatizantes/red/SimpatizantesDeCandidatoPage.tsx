// src/pages/private/simpatizantes/red/SimpatizantesDeCandidatoPage.tsx
...
const SimpatizantesDeCandidatoPage: FC = () => {
  ...
  const getColorIntencion = useCallback((intencion: string): string => {
    switch (intencion) {
      case "SEGURO":
      ...
      <div className="py-4 px-6">
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <PageHeader
            ...
            subtitle={`@${usuario.username} — ${usuario.perfil.es_operativo ? "Operativo" : (usuario.nivel?.nombre ?? "Sin nivel")} — Vista por pertenencia politica`}
            showDivider={false}
          />
        </div>
...
export default SimpatizantesDeCandidatoPage;