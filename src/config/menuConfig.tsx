...
export const menuConfig: MenuItemConfig[] = [
  ...
  {
    key: "simpatizantes-registrar-para",
    icon: <Users size={18} />,
    label: "Registrar para Candidato",
    path: RoutesConfig.simpatizantesRegistrarPara,
    modulo: "simpatizantes",
    permisoEspecifico: "registrar_simpatizante_para_terceros",
  },
  {
  ...
  {
    key: "simpatizantes-consulta-voto",
  ...
  {
    key: "simpatizantes-dashboard-votacion",
    icon: <BarChart3 size={18} />,
    label: "Dashboard Votación",
  ...
  {
    key: "impresoras-reportes",
    icon: <FileDown size={18} />,
    label: "Reporte Impresiones",
    path: RoutesConfig.impresorasReportes,
    modulo: "impresoras",
    permisoEspecifico: "ver_reportes_impresion",
  },
  {
    key: "puestos",
    icon: <MapPin size={18} />,
    ...
    modulo: "puestos",
    permisoEspecifico: "gestionar_puestos",
  },
  {
    key: "activador-panel",
    icon: <Ticket size={18} />,
    label: "Activar Tickets",
    path: RoutesConfig.activadorPanel,
    modulo: "tickets",
    permisoEspecifico: "activar_ticket",
  },
  {
    key: "activador-cupos",
    ...
    modulo: "tickets",
    permisoEspecifico: "gestionar_cupos_activador",
  },
  {
    key: "verificador-panel",
    icon: <UserCheck size={18} />,
    label: "Verificar Asistencia",
    path: RoutesConfig.verificadorPanel,
    modulo: "tickets",
    permisoEspecifico: "verificar_asistencia",
  },
  {
    key: "solidaridad-panel",
    icon: <Heart size={18} />,
    label: "Solidaridad",
    path: RoutesConfig.solidaridadPanel,
    modulo: "tickets",
    permisoEspecifico: "registrar_solidaridad",
  },
  {
    key: "template-tickets",
    icon: <PenTool size={18} />,
    label: "Disenar Tickets",
    path: RoutesConfig.templateLista,
    modulo: "tickets",
    permisoEspecifico: "gestionar_template_ticket",
  },
];
